                        ...
                        foreach ($tp as $key => $value) { ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <button class="btn btn-warning" data-toggle="modal" data-target="#edit<?= $value['id_tp']  ?>"><i class="fa fa-pencil"></i></button>
                                    <button class="btn btn-danger" data-toggle="modal" data-target="#delete<?= $value['id_tp']  ?>"><i class="fa fa-trash"></i></button>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
